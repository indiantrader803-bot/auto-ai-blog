...
export async function runAutonomousFleetTrafficBooster() {
  ...
  const affiliateOffers = [
    ...
    { name: "AquaFunded Prop Firm Challenge (Code: 6e9)", url: "https://www.aquafunded.com/?afmc=6e9", payout: 80.0, slugMatch: ["aqua", "aquafunded", "prop", "funded", "forex", "trading", "scaling", "challenge", "capital"] },
    { name: "Atlas Funded Prop Trading ($200k Challenge)", url: "https://affiliates.atlasfunded.com/Tracking/click/?affid=12275&campaign=11320&product_id=1&t_type=Register&t_lang=EN", payout: 90.0, slugMatch: ["atlas", "atlasfunded", "prop", "funded", "evaluation", "forex", "trading", "futures", "nifty"] },
