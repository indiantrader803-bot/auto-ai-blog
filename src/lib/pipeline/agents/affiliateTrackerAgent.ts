...
export const MASTER_AFFILIATE_PROGRAMS: AffiliateProgramData[] = [
  ...
  {
    id: "aff_fundedsquad",
    platform: "FundedSquad",
    name: "FundedSquad Instant & Evaluation Challenge",
    category: "Prop Trading",
  ...
  {
    id: "aff_equityedge",
    platform: "Equity Edge",
    name: "Equity Edge Evaluation & Scaling Plans",
    category: "Prop Trading",
    targetUrl: "https://app.equityedge.io/signup/THESMARTMAG/",
    promoCode: "THESMARTMAG",
    payoutModel: "30% Lifetime RevShare",
    baseCpa: 70.0,
    clicks: 0,
    uniqueClicks: 0,
    purchases: 0,
