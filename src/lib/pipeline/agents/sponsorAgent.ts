...
export const VERIFIED_SPONSORS: SponsorDeal[] = [
  ...
  {
    id: "sp_fundedsquad",
    sponsorName: "FundedSquad Prop Firm",
    badge: "🔥 BUY 1 GET 2 FREE SUMMER OFFER",
    tagline: "35% Instant Discount + 3 Accounts for the Price of 1 on $25K+",
    description: "Instant funding & rapid evaluation models. Trade crypto, forex & indices with up to 90% profit split and zero minimum trading days.",
    ctaText: "Claim Buy 1 Get 2 Free Deal →",
    ctaUrl: "https://fundedsquad.com/?campaign=thesmartmag&squad=3552",
    discountCode: "CHARGE",
    categoryMatch: ["Indian Markets", "US Markets", "Forex & Currencies", "Commodities", "Finance & Markets", "Trading"],
    cpcTier: "ULTRA",
  },
  {
    id: "sp_equityedge",
    sponsorName: "Equity Edge Prop Firm",
    badge: "VERIFIED PARTNER ACCESS",
    tagline: "Up to 90% Profit Splits, Zero Time Limits & Scaling to $2,000,000",
    description: "Professional Forex, Crypto & CFD evaluations with fast bi-weekly payouts, refundable fees, and direct partner onboarding with code THESMARTMAG.",
    ctaText: "Start Equity Edge Challenge →",
    ctaUrl: "https://app.equityedge.io/signup/THESMARTMAG/",
    discountCode: "THESMARTMAG",
    categoryMatch: ["Indian Markets", "US Markets", "Forex & Currencies", "Commodities", "Finance & Markets", "Trading"],
    cpcTier: "ULTRA",
  },
  {
  ...
  },
  {
    ...
    tagline: "Updated Reserve Plans from $48 & Guardian Protector Risk Engine",
    description: "Trade Forex, Crypto, Indices & Commodities with up to $400k capital. New 25K Reserve at $48, 5X bundles from $41/acct, and optional No Daily Loss Limit.",
