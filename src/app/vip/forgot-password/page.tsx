          ...
          {status === 'success' ? (
            <div className="text-center space-y-4">
              ...
              <div className="pt-4">
                <Link
                  href="/vip/login"
                  className="inline-block w-full py-2.5 px-4 bg-slate-800 hover:bg-slate-700 text-slate-200 text-sm font-semibold rounded-xl text-center transition-colors border border-slate-700"
                >
