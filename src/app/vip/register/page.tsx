      ...
      <main className="flex-1 flex items-center justify-center p-4 sm:p-6 py-16">
        <div className="w-full max-w-md rounded-3xl bg-[#0b1329]/90 border border-slate-800 p-8 shadow-2xl backdrop-blur-xl relative overflow-hidden">
          ...
          <div className="text-center space-y-2 mb-8 relative z-10">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-black uppercase tracking-wider bg-gradient-to-r from-teal-500/20 to-cyan-500/20 text-teal-400 border border-teal-500/30">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-[10px] text-slate-500">We will dispatch your VIP activation credentials here.</p>
            </div>

            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-slate-300 block">Choose Password</label>
              <div className="relative">
            ...
            <div className="p-3 rounded-xl bg-teal-950/30 border border-teal-800/40 text-[11px] text-teal-300 space-y-1">
              <div className="flex items-center gap-1.5 font-bold">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
                <span>100% Free Forever VIP Perks</span>
              </div>
              <p className="text-slate-400 text-[10px]">Zero credit card required. Instant access to all proprietary models.</p>
            </div>
          ...
          <div className="mt-6 pt-6 border-t border-slate-800 text-center text-xs text-slate-400">
            ...
            <Link href="/vip/login" className="text-teal-400 hover:text-teal-300 font-bold">
              Log In here
            </Link>
          </div>
        </div>
