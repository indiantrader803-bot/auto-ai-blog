...
export default function MonetizationHubPage() {
  ...
  const [affiliates, setAffiliates] = useState([
    ...
    },
    {
      ...
      cpa: "20% RevShare + $85.00 CPA",
      clicks: 32,
      earnings: "$170.00 (2 Sales)",
      status: "ACTIVE",
      badge: "HOT SCALING",
      promoCode: "GGG34QEO",
    },
  ...
  const handleAddSponsor = (e: React.FormEvent) => {
    ...
    const added: SponsorDeal = {
      ...
      ctaUrl: newSponsor.ctaUrl || "https://auto-ai-blog-web.onrender.com",
