...
export default function FlightCompensationCalculator() {
  ...
  const getPayoutAmount = () => {
    if (flightDistance === "short") return 250;
    if (flightDistance === "medium") return 400;
    return 600;
  };
  ...
  return (
    <section className="w-full rounded-3xl bg-gradient-to-b from-indigo-50 dark:from-indigo-950/80 via-white dark:via-slate-900 to-slate-50 dark:to-slate-950 border border-indigo-200 dark:border-indigo-900/40 p-5 sm:p-10 text-slate-900 dark:text-white shadow-2xl relative overflow-hidden font-sans transition-colors">
      {/* Glow Decor */}
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <div className="lg:col-span-6 space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-indigo-500/10 dark:bg-indigo-500/20 border border-indigo-500/30 text-indigo-600 dark:text-indigo-300 text-[11px] font-black uppercase tracking-wider">
        ...
        <div className="lg:col-span-6 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-700/80 p-5 sm:p-7 shadow-xl">
          ...
          {/* Result Box */}
          <div className="p-4 rounded-2xl bg-gradient-to-r from-emerald-500/10 dark:from-emerald-500/20 to-indigo-500/10 dark:to-indigo-500/20 border border-emerald-500/30 flex items-center justify-between gap-4">
            <div>
            ...
            <div className="text-right">
              <span className="text-[10px] text-emerald-700 dark:text-emerald-300 bg-emerald-500/20 px-2 py-0.5 rounded-full font-bold uppercase">
                Guaranteed Law
              </span>
            </div>
          </div>
          ...
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <button
              ...
              className="py-3 px-4 rounded-xl bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-500 hover:to-indigo-600 text-white font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-1.5 shadow-md shadow-indigo-600/20 transition-all hover:scale-[1.02] active:scale-95 cursor-pointer"
            >
