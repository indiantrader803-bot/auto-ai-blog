...
export const BOOKING_WIDGET_TABS: BookingWidgetTab[] = [
  {
    ...
    icon: Plane,
    scriptSrc:
      "https://tpemb.com/content?currency=USD&trs=573790&shmarker=777349&language=en&theme=1&powered_by=true&campaign_id=1&promo_id=1486",
  ...
  },
  {
    ...
    icon: Building2,
    scriptSrc:
      "https://tpemb.com/content?trs=573790&shmarker=777349&locale=en&width=100&height=100&powered_by=true&campaign_id=10&promo_id=2082",
  ...
  },
  {
    ...
    icon: Ticket,
    scriptSrc:
      "https://tpemb.com/content?currency=USD&trs=573790&shmarker=777349&locale=en&city_id=2&category=4&amount=3&powered_by=true&campaign_id=137&promo_id=4497",
  ...
  },
  {
    ...
    icon: Car,
    scriptSrc:
      "https://tpemb.com/content?currency=usd&trs=573790&shmarker=777349&powered_by=true&locale=en&campaign_id=111&promo_id=4484",
  ...
  },
  {
    ...
    icon: ShieldCheck,
    scriptSrc:
      "https://tpemb.com/content?trs=573790&shmarker=777349&locale=en&powered_by=true&color_button=%23f2685f&color_focused=%23f2685f&secondary=%23FFFFFF&dark=%2311100f&light=%23FFFFFF&special=%23C4C4C4&border_radius=5&plain=false&no_labels=true&promo_id=8588&campaign_id=541",
  ...
  },
  {
    ...
    icon: MapPin,
    scriptSrc:
      "https://tpemb.com/content?currency=USD&trs=573790&shmarker=777349&language=en&layout=full&orientation=vertical&powered_by=true&campaign_id=89&promo_id=3984",
...
export default function InteractiveTravelBookingBar({
  ...
  return (
    <div className={`w-full rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 sm:p-8 text-slate-900 dark:text-white shadow-2xl relative overflow-hidden font-sans transition-colors ${className}`}>
      {/* Glow Effect */}
      <div className="absolute top-0 right-0 w-80 h-80 bg-sky-500/10 rounded-full blur-3xl pointer-events-none" />

      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6 pb-4 border-b border-slate-200 dark:border-slate-800 relative z-10">
        <div>
          <div className="flex items-center gap-2 mb-1.5">
            <span className="px-3 py-1 rounded-full bg-sky-500/10 dark:bg-sky-500/20 border border-sky-500/30 text-sky-600 dark:text-sky-400 text-[10px] font-black uppercase tracking-wider flex items-center gap-1">
          ...
          <h3 className="text-lg sm:text-2xl font-black font-serif text-slate-900 dark:text-white tracking-tight">
            {title}
          </h3>
      ...
      <div className="relative z-10 w-full overflow-hidden rounded-2xl">
        <TravelpayoutsWidget
          ...
          className="!bg-white dark:!bg-slate-950/90 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white"
        />
      </div>
    </div>
  );
